...
- Geen `Co-Authored-By: Codex` of andere Codex/Anthropic-attributie
- Geen vermelding van Codex, Anthropic of AI-tools in commit messages, PR descriptions, of comments
...
| `/update-config` | Wijzigt `.Codex/settings.local.json` — permissies, env vars, hooks |
